...
template <class T>
kaldi::int32 edit_distance(const std::vector<T> &ref, const std::vector<T>& hyp) {
    return kaldi::LevenshteinEditDistance(ref, hyp);
}
...
template <class T>
ErrorStats edit_distance_stats(const std::vector<T> &ref, const std::vector<T>& hyp) {
    ErrorStats e;
...
PYBIND11_MODULE(kaldi_edit_distance, m) {
    ...
    m.def("edit_distance_stats", edit_distance_stats<std::int64_t>, "Levelshtein edit distance between hyp and ref",
          py::arg("ref"), py::arg("hyp"));

    m.def("edit_distance_stats", edit_distance_stats<std::string>, "Levelshtein edit distance between hyp and ref",
          py::arg("ref"), py::arg("hyp"));
